...
# TODO: use a list comprehension to create a list of all of the full_names in lower case
lowercase_full_names = full_names = [name.lower() for name in full_names]
...
greater_than_9 = [number for number in integers if number > 9]
